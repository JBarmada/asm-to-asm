...
bb.12:                                            ; preds = %bb.11
  ...
  store i64 %119, ptr %R12D-SKT-LOC, align 1
  %120 = zext i32 %CMOV83 to i64
  store i64 %120, ptr %R12D-SKT-LOC67, align 1
  br label %bb.13
...
bb.13:                                            ; preds = %bb.12, %bb.11
  ...
  store i64 %126, ptr %EBP-SKT-LOC, align 1
  %127 = zext i32 %EBP99 to i64
  store i64 %127, ptr %EBP-SKT-LOC65, align 1
  br label %bb.14
...
bb.16:                                            ; preds = %bb.15
  ...
  store i64 %154, ptr %R12D-SKT-LOC, align 1
  %155 = zext i32 %CMOV137 to i64
  store i64 %155, ptr %R12D-SKT-LOC120, align 1
  %156 = zext i32 %CMOV137 to i64
  store i64 %156, ptr %R12D-SKT-LOC67, align 1
  br label %bb.2
